---
name: engine
description: "# @hyperframes/engine Seekable web-page-to-video rendering engine built on Puppeteer and FFmpeg. Framework-agnostic: works with GSAP, Lottie, Three.js, CSS animations, or any web content that implements the `window.__hf` seek protocol. ## Instal..."
---
