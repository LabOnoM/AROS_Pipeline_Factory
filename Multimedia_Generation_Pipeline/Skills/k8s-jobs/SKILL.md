---
name: k8s-jobs
description: "# K8s / Cloud Run / ECS reference Dockerfile This directory ships a reference `Dockerfile.example` for adopters who want to run HyperFrames distributed renders **outside AWS Lambda**. The image bakes Node 22 + `chrome-headless-shell` + `ffmpeg` ..."
---
