---
name: tier-1-title-card
description: "# Tier 1 — title-card-fade ## What it tests The simplest non-trivial Remotion → HyperFrames translation. A single text element fades in over the first 0.5 s, holds for 2.0 s, and fades out over the last 0.5 s. No audio, no media, no custom compo..."
---
