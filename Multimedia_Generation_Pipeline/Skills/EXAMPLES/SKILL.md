---
name: EXAMPLES
description: "# EXAMPLES —— 完整章节 / 题材 anchor > ## ⚠️ 这是**结构示意**，不是抄袭模板 > > 这些 example **不是给你照抄的**。它们的角色是'看一个完整章节大概 > 什么形状、动画怎么分层、CSS 用了哪些 token、outline 长什么样'。 > > **正确使用流程**： > > 1. 走完 [`../CHAPTER-CRAFT.md`](../CHAPTER-CRAFT.md) Part 0 五问 > 2. 实在卡壳'我这一章的整体结构..."
---
