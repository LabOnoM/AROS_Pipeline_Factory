---
name: design-system
description: "# Style Preset Standard - Using Block Frame as the Reference `block-frame/` is the **reference implementation (reference preset)**. This README defines what a style preset must contain, what each part outputs, and how to **add / refactor / conve..."
---
