---
name: releases
description: "# Release notes Reviewed GitHub Release bodies live here. Create the next draft with: ```bash bun run release:prepare <version> ``` The first run drafts missing changelog artifacts and exits non-zero for review. After rewriting the generated TOD..."
---
