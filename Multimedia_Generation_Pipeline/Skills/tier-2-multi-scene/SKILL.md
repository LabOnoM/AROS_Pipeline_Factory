---
name: tier-2-multi-scene
description: "# Tier 2 — title-image-outro ## What it tests Three-scene composition. Each scene exercises a different Remotion idiom: 1. **Scene 1 (0–2 s)** — TitleScene with `spring({damping:12, stiffness:100, mass:1})` driving a `transform: scale()` on text..."
---
