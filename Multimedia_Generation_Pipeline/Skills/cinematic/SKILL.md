---
name: cinematic
description: "# Cinematic mode (pure embed) — one engine, six DNAs > Cinematic mode compiles **[../../dna/](../../dna/README.md)** through > **[engine.html](engine.html)** (`make-composition.cjs`). The old per-template HTML > shells are retired — `cinematic-c..."
---
