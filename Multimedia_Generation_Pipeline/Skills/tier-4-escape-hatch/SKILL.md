---
name: tier-4-escape-hatch
description: "# Tier 4 — escape-hatch ## What it tests T4 is the **lint-only** tier. There are no renders to diff — the skill is graded on whether it correctly _refuses_ to translate each case (and recommends the runtime interop pattern from PR #214 instead) ..."
---
