...
description: "# hdr-hlg-regression Regression test that locks down end-to-end **HDR HLG (BT.2020 ARIB STD-B67)** video rendering. Companion to `hdr-regression` (PQ), kept as a separate suite so the HLG-specific encoder/metadata path stays tested in isolation...."
---
