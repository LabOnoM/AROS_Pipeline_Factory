---
name: hook-chapter
description: "# Anchor: hook-chapter（钩子型开场） > ⚠️ **这是结构示意，不是抄袭模板**。先走 [`../../CHAPTER-CRAFT.md`](../../CHAPTER-CRAFT.md) > Part 0 五问。本 anchor 给的是'钩子型开场的结构骨架'——你要保留它的 > step 切分逻辑、字号关系、布局原则，**按本项目的主题 + 内容换动作 > 选型**。倒过来照抄 = [`../../CHAPTER-CRAFT.md`](../../CHAPT..."
---
