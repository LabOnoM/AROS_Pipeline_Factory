---
name: updates
description: "# Weekly updates Weekly digest source files and social drafts live here. Generate the next editorial packet with: ```bash bun run changelog:weekly --from YYYY-MM-DD --to YYYY-MM-DD --write ``` Run the command from an up-to-date `main` branch so ..."
---
