---
name: core
description: "# @hyperframes/core Types, parsers, generators, compiler, linter, runtime, and frame adapters for the Hyperframes video framework. ## Install ```bash npm install @hyperframes/core ``` > Most users don't need to install core directly — the [CLI](..."
---
