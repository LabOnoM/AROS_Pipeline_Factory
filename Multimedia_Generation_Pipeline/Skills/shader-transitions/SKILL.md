...
description: "# @hyperframes/shader-transitions WebGL shader transitions for HyperFrames compositions. Renders GPU-accelerated scene-to-scene transitions using fragment shaders, driven by GSAP timelines. ## Install ```bash npm install @hyperframes/shader-tran..."
---
