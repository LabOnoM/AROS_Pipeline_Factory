---
name: _shared
description: "# `_shared/` — Common content for nature-* skills This directory is **not a skill**. It has no `SKILL.md` and is not registered with the plugin loader. It exists so multiple skills can reference the same content without duplication. Files here a..."
---
