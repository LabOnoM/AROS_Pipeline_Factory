---
name: mcp-server
description: "# Unified Academic Search MCP Server 统一的学术搜索 MCP 服务器，整合 CrossRef、PubMed、arXiv、Scopus、ScienceDirect 数据源。 ## 工具 | 工具 | 功能 | |------|------| | `search_papers` | 统一搜索，支持多数据源并发 | | `get_paper_by_id` | 按 DOI/PMID/arXiv ID 获取详情 | | `get_citation` | 格式化..."
---
