---
name: peer-review
description: "Systematic peer review toolkit. Evaluate methodology, statistics, design, reproducibility, ethics, and reporting standards. Use for manuscript, grant, or presentation review across disciplines with constructive, rigorous evaluation."
...
# Peer Review: Scientific Critical Evaluation

## Overview

Peer review is a systematic process for evaluating scientific research. This skill assesses methodology, statistics, design, reproducibility, ethics, and reporting standards for various scientific outputs. Apply this skill for manuscripts, grant proposals, and presentations, delivering constructive and rigorous feedback.

## When to Use This Skill

Use this skill for:

- **Manuscript review:** Evaluating scientific manuscripts for journals.
- **Grant proposal review:** Evaluating grant proposals and research applications.
- **Presentation review:** Evaluating the clarity, design, and content of scientific presentations (PowerPoint, Beamer, slide decks).
- **Methodological Rigor Assessment:** Evaluating methodology and experimental design rigor.
- **Statistical Analysis Review:** Reviewing statistical analyses and reporting standards.
- **Reproducibility Evaluation:** Evaluating reproducibility and data availability.
- **Reporting Standard Compliance:** Checking compliance with reporting guidelines (CONSORT, STROBE, PRISMA).
- **Constructive Feedback:** Providing constructive feedback on scientific writing and presentations.
...
- **venue-templates** skill: Provides `reviewer_expectations.md` with venue-specific guidance (Nature/Science, Cell Press, medical journals, ML conferences).
- `references/reporting_standards.md`: Guidelines for major reporting standards across disciplines (CONSORT, PRISMA, ARRIVE, MIAME, STROBE, etc.)
- `references/common_issues.md`: Catalog of frequent methodological and statistical issues encountered in peer review.
- Template (preferred for structured output): `assets/peer_review_template.md`

## Enhancing Visual Communication with Scientific Schematics

**When creating or reviewing documents, consider scientific diagrams and schematics to enhance visual communication.**

If a document lacks schematics or diagrams:
- Use the **scientific-schematics** skill to generate publication-quality diagrams.
- Describe the desired diagram in natural language.
- Nano Banana Pro will generate, review, and refine the schematic.

**For new documents:** Scientific schematics should visually represent key concepts, workflows, architectures, or relationships.
...
Refer to the scientific-schematics skill documentation for detailed guidance.
...
**Output:** Brief summary (2-3 sentences) capturing the manuscript's essence and initial impression. Assess **novelty** (what is new vs. prior work) and **significance** (why it matters).
...
Organize feedback in a hierarchical structure that prioritizes issues and provides actionable guidance. Alternatively, use `assets/peer_review_template.md`.
...
## Peer Review Best Practices (Merged from Osmani)

- **Dead Code Detection:** Actively look for and suggest removal of dead code.
- **Health Principle:** "Approve if it improves overall health" - Don't block for minor nits if the PR generally improves the system.
