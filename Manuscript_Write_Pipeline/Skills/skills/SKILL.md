---
name: skills
description: "# Skills：面向读者的技能导读 [English](README.en.md) · 中文 你点进这个目录，大概是想搞清楚 Supervisor-Skills 的'可执行核心'到底是什么。这份 README 就是为你准备的：**不装插件也能当做科研思考清单用，装了插件之后也知道怎么用、什么时候用、用哪一个。** ## 这份 README 在项目里的位置 Supervisor-Skills 的内容被分成三层，各有各的读者： | 入口 | 读者 | 作用 | |---|---|---|..."
---
