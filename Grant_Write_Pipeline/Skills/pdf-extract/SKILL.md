...
## PDF Editing & Redaction (Merged from Benchflow)

- Go beyond pure text extraction: support coordinate-based redaction and metadata stripping for double-blind review compliance.
