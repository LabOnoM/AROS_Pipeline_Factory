...
2.  **Generate Mermaid Code**:
    *   Construct a Mermaid `flowchart TD` diagram.
...
## References
*   [Prompt Guidelines](references/prompt_guidelines.md) - Detailed rules for content extraction and formatting.
...
- If a file is produced, prefer a deterministic output name such as `text_to_technical_roadmap_result.md` unless the skill documentation defines a better convention.
