...
- Execution model: Validate the request, choose the documented workflow, and produce a bounded deliverable.
...
## When to Use This Skill (Expanded)
...
PathML provides six major capability areas, all documented in detail in the reference files:
