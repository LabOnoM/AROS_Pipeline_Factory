...
license: MIT
skill-author: AIPOCH
original-source: mattpocock/skills/improve-codebase-architecture
---
...
## Deep Module Analysis & Vertical Slicing (Merged from Pocock)

- **Deep Modules:** Extract functionality into "deep modules" (simple interface, complex implementation) as per *A Philosophy of Software Design*.
- **Vertical Slicing (Tracer Bullets):** Break refactors into thin vertical slices that cut through all layers, rather than horizontal layer-by-layer rewrites.
- **TDD-Based Fixes:** Plan refactor commits based on failing tests first.
