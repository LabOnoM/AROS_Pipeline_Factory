---
name: starter_motion
description: "# Motion Starter Template A minimal, production-ready starter template for building animated React applications with Framer Motion. ## Features - ⚡️ **Vite** - Fast build tool and dev server - ⚛️ **React 18** - Latest React with concurrent featu..."
---
