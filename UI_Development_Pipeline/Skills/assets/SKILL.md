---
name: assets
description: "# Substance 3D Texturing Assets Pre-configured export preset templates for various web engines and platforms. ## Directory Structure ``` assets/ └── export_templates/ ├── gltf_standard.json # glTF 2.0 compliant preset ├── threejs_optimized.json ..."
---
