---
name: .factory
description: "# Factory Droids - Frontend Specialist Subagents 22 comprehensive Factory AI droids converted from Claude skills for specialized frontend development tasks. ## How to Use Droids Invoke via the Task tool in Factory CLI: ``` > Use the subagent thr..."
---
