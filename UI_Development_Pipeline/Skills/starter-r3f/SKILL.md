---
name: starter_r3f
description: "# React Three Fiber Starter Template A minimal, production-ready starter template for building 3D experiences with React Three Fiber (R3F), Drei helpers, and Vite. ## Features - ⚡️ **Vite** - Fast build tool and dev server - ⚛️ **React 18** - La..."
---
