---
name: examples
description: "# GSAP ScrollTrigger Examples Real-world patterns and implementations for common ScrollTrigger use cases. ## 📚 Available Examples ### Core Patterns All examples are self-contained HTML files demonstrating specific ScrollTrigger patterns. Open an..."
---
