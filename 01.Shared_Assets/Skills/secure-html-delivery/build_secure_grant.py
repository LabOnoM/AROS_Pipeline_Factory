...
TOKEN = b'AI4SCIENCE-2026-Wb3D'
INPUT_FILE = 'WholeBrain3D_Interactive_EN.html'
OUTPUT_FILE = 'index.html'

with open(INPUT_FILE, 'rb') as f:
    html_content = f.read()

# 2. Derive 256-bit key using SHA-256
...
# 5. Generate Output HTML template
...
<body>
    <div class="lock-container">
        ...
        <p>WholeBrain3D Grant Proposal is secured via AES-256-GCM. <br><br>Please scan the official QR code or provide the token in the URL to decrypt and view the document.</p>
...
print(f"Successfully generated encrypted HTML at: {OUTPUT_FILE}")
