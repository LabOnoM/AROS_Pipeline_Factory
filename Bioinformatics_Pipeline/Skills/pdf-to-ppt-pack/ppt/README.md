...
A modern presentation framework based on HTML/CSS/JS, featuring a **pluggable architecture** and supporting rich animation effects and interactive functions.
...
Open `framework/index.html` directly in your browser to view the presentation.
...
python build_html.py helixlife-20260130                 # Project name (searches in projects/ automatically)
...
- **v3.0.0** - Pluggable architecture refactoring, modular component system