...
name: paper-2-web
---
description: Generated skill paper-2-web

---
name: paper-2-web
description: Convert academic papers to promotional formats: interactive websites (Paper2Web), presentation videos (Paper2Video), and conference posters (Paper2Poster). Use for paper dissemination, conference prep, explorable homepages, video abstracts, or printable posters from LaTeX or PDF.
license: MIT
skill-author: AIPOCH
...
This skill converts academic papers into promotional and presentation formats using the Paper2All autonomous pipeline, transforming research papers (LaTeX or PDF) into:
...
The pipeline uses LLM-driven content extraction, design generation, and iterative optimization for high-quality outputs suitable for conferences, journals, preprint repositories, and academic promotion.

## When to Use

-   Use this skill when the request aligns with its documented task boundary.
-   Use it when the user can provide the required inputs and expects a structured deliverable.
-   Prefer this skill for repeatable, checklist-driven execution, not open-ended brainstorming.

## Key Features

-   Scope-focused workflow: Convert academic papers to promotional formats: interactive websites (Paper2Web), presentation videos (Paper2Video), and conference posters (Paper2Poster). Suitable for paper dissemination, conference prep, creating explorable academic homepages, generating video abstracts, or producing printable posters from LaTeX or PDF.
-   Documentation-first workflow with no packaged script requirement.
-   Reference material in `references/` provides task-specific guidance.
-   Structured execution path ensures consistent, reviewable outputs.

## Dependencies

See `## Prerequisites` for related details.
...
See `## Overview` for related details.
...
-   **Promoting research**: Convert published papers or preprints into accessible, engaging web formats.
-   **Preparing presentations**: Generate video abstracts or full presentation videos from paper content.
-   **Disseminating findings**: Create promotional materials for social media, lab websites, or institutional displays.
-   **Enhancing preprints**: Add interactive homepages to bioRxiv, arXiv, or other preprint submissions.
...
**Consider adding scientific diagrams and schematics to enhance visual communication.**

If your document doesn't include schematics or diagrams:
...
-   Nano Banana Pro will generate, review, and optimize the schematics automatically.

**For new documents**: Generate scientific schematics by default to intuitively depict key concepts, workflows, architectures, or relationships described in the text.
...
Transforms papers into layout-aware, interactive academic homepages.
...
-   Do not fabricate measurements, references, findings, or conclusions not supported by the source material.
