---
name: pydicom
description: Python library for working with DICOM (Digital Imaging and Communications in Medicine) files. Use this skill when reading, writing, or modifying medical imaging data in DICOM format; extracting pixel data from medical images (CT, MRI, X-ray, ultrasound); anonymizing DICOM files; processing DICOM metadata and tags; converting DICOM images to other formats; handling compressed DICOM data; or working with medical imaging datasets. Applies to tasks involving medical image analysis, PACS systems, radiology workflows, and healthcare imaging applications.
...
- Tasks where a packaged method is needed instead of ad-hoc output
- Situations where a concrete deliverable, validation step, or file-based result is expected
