---
name: biopython
description: Comprehensive toolkit for computational molecular biology; use it for programmatic sequence/structure parsing, batch bioinformatics pipelines, and automated NCBI/BLAST workflows.
license: MIT
metadata:
    skill-author: AIPOCH and K-Dense Inc.
---

## Overview

Biopython is a set of freely available Python tools for computational biology. It provides modules for sequence manipulation, file I/O, database access, structural bioinformatics, phylogenetics, and more.
...
- Perform structural bioinformatics tasks, including parsing PDB files and calculating distances.
...
- **Advanced Features**: Motifs, population genetics, sequence utilities, restriction analysis, clustering and genome diagrams.
...
1.  **Read relevant reference documentation** before writing code.
...
8.  **Keep Biopython updated** to get the latest features and bug fixes.
