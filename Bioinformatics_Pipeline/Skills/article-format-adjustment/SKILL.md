...
## Information Dependency & Chunking (Merged from Pocock)

- **DAG-based ordering:** Does Section B require understanding Section A? If so, A must precede B.
- **240-Character Rule:** Break paragraphs that exceed 240-300 characters to ensure scannability.
