...
license: MIT
skill-author: AIPOCH
original-source: addyosmani/agent-skills/planning-and-task-breakdown
---
...
## Task Breakdown Techniques (Merged from Osmani)

- **Scope Estimation:** Assign rough effort estimates to tasks.
- **Parallel Work:** Identify tasks that can be done concurrently by different sub-agents.
- **Ordered Tasks:** Track dependencies between tasks strictly.
