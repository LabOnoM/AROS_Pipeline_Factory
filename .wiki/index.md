...
- [[Manuscript_Write_Pipeline]]: Manuscript authoring (Markdown-first).
...
- [[aros_asset_deployment]]: Canonical routing to AROS runtime.
- [[citation_before_claim_protocol]]: Scientific grounding standards.
- [[conda_environment_standard]]: Environment reproducibility.
- [[cross_pipeline_compatibility_protocol]]: CPCP governance.
- [[excel_injection]]: Data hydration patterns.
- [[pipeline_registry_migration]]: Repository restructuring.
- [[secure_html_delivery]]: Portability and security.
- [[self_healing_environment_policy]]: L0→L1→L2 recovery.
- [[unified_diagramming]]: Standardized visualization.
...
## 🏛️ System History
- [[lessons-learned]]: Codebase wisdom and past failures.
