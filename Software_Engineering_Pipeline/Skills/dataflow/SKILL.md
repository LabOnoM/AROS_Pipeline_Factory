---
name: dataflow
description: "# Data Flow Renderer Render `diagram_type: 'dataflow'` JSON files into the standard Archify HTML template. ```bash node archify/renderers/dataflow/render-dataflow.mjs input.dataflow.json output.html ``` Run `npm install` once in the skill folder..."
---
