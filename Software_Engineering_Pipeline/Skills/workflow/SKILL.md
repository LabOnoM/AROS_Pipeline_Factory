---
name: workflow
description: "# Workflow Renderer Render `diagram_type: 'workflow'` JSON files into the standard Archify HTML template. ```bash node archify/renderers/workflow/render-workflow.mjs input.workflow.json output.html ``` Run `npm install` once in the skill folder ..."
---
