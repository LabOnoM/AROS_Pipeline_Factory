...
license: MIT
skill-author: AIPOCH
original-source: addyosmani/agent-skills/security-and-hardening
---
...
## Security & Hardening Workflow (Merged from Osmani)

- **OWASP Patterns:** Actively look for injection, broken auth, sensitive data exposure.
- **Input Validation:** Enforce strict allow-listing for file inputs.
- **Secrets Scanning:** Never commit or process files containing bare credentials.
- **Dependency Audit:** Routinely check package manifests for vulnerable packages.
