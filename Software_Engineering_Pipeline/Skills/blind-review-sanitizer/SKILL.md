...
## PDF Redaction (Merged from Benchflow)
- Use automated PDF redaction techniques to securely remove author metadata, affiliations, and self-citations before double-blind review.
