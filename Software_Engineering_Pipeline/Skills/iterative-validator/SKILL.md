...
python ~/.gemini/skills/iterative-validator/scripts/main.py \
    ...
    --destination "~/.gemini/antigravity/knowledge/my-new-ki/my-new-ki.md" \
    --task_type "knowledge_retrieval"
```


## Stop-The-Line Validation (Merged from Osmani)

- If validation fails repeatedly with the same signature, STOP guessing.
- Formulate a clear hypothesis before attempting the next fix.
- "Isolate -> Root Cause -> Fix -> Guard"
