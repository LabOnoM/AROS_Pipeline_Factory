---
name: lifecycle
description: "# Lifecycle Renderer Render `diagram_type: 'lifecycle'` JSON files into the standard Archify HTML template. ```bash node archify/renderers/lifecycle/render-lifecycle.mjs input.lifecycle.json output.html ``` Run `npm install` once in the skill fo..."
---
