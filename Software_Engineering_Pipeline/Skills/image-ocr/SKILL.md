...
## Multimodal OCR Fallbacks (Merged from Benchflow)

- If traditional OCR (Tesseract/EasyOCR) fails on complex scientific charts or diagrams, fallback to Gemini 2.5 Pro Vision or OpenAI Vision for semantic layout understanding.
